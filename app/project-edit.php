...
<head>
    ...
    <title><?= WEBSITE_NAME ?> | Edit Project</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-xl-8 col-lg-8 mx-auto">
                            ...
                            <!-- Card Body -->
                            <div class="card-body">
                                <form action="../classes/Project.php?f=edit_project" method="POST">
                                    <input type="hidden" name="projectId" value="<?= $projectId?>">
                                    <div class="form-group">
                                        <label for="title">Title</label>
                                        <input type="text" class="form-control" id="title" name="title" value="<?= $projects[0]['title']?>" required>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="category">Category</label>
                                            <select class="form-control" id="category" name="category" required>
                                                <option><?= $projects[0]['category']?></option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="visibility" name="visibility" required>
                                                <option><?= $projects[0]['visibility']?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="descriptions" name="description" rows="4" required>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="fundingType" name="fundingType" required>
                                                <option><?= $projects[0]['fundingType']?></option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control text-left" id="fundingAmount" name="fundingAmount" value="<?= $projects[0]['fundingAmount']?>" required>
                                        </div>
                                    </div>
                                        <div class="form-group">
                                            <label for="fundingDescription">Funding Description</label>
                                            <textarea class="form-control" id="fundingDescription" name="fundingDescription" rows="4" required><?= $projects[0]['fundingDescription']?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="requirements">Requirements</label>
                                            <textarea class="form-control" id="requirements" name="requirements" rows="4" required><?= $projects[0]['requirements']?></textarea>
                                        </div>
